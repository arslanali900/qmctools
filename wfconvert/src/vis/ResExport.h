...
class ResExportClass : public Gtk::Window
{
private:
  ResVisualClass &Visual;
...
public:
  ...
  void ExportMovie (string basename, int firstFrame, int lastFrame, 
		    int interpFactor);
  void SetupWidgets();
  ResExportClass (ResVisualClass &visual);
};
