...
MODULE pw_restart
  ...
  LOGICAL :: lcell_read   = .FALSE., &
             ...
             lsymm_read   = .FALSE.
  ! For qmcpack
  CHARACTER(256)          :: h5name,eigname
  INTEGER                 :: h5len, tmpint
  ...
  CONTAINS
    ...
    SUBROUTINE pw_writefile( what )
      ...
      !
      !!! ESHDF ADDITION
      INTEGER               :: nelec_tot,nup,ndown,n_rgrid(3),oldh5
      INTEGER               :: psi_r_is_complex
      REAL(DP)              :: g_red(3)
      !
      lwfc  = .FALSE.
      !
      ...
      CASE( "all" )
         !
         lwfc  = twfcollect
         h5name = TRIM( tmp_dir )//TRIM( prefix ) //'.pwscf.h5'
